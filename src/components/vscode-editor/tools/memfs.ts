...
export class MemFs implements vscode.FileSystemProvider {
  ...
  stat(uri: vscode.Uri): vscode.FileStat {
    console.trace(`MemFs.stat ${this.id}. uri: ${uri}`);
  ...
  readDirectory(uri: vscode.Uri): [string, vscode.FileType][] {
    console.trace(`MemFs.readDirectory ${this.id}. uri: ${uri}`);
  ...
  readFile(uri: vscode.Uri): Uint8Array {
    console.trace(`MemFs.readFile ${this.id}. uri: ${uri}`);
  ...
  writeFile(uri: vscode.Uri, content: Uint8Array, { create, overwrite }: { create: boolean; overwrite: boolean }): void {
    console.trace(`MemFs.writeFile ${this.id}. uri: ${uri}`);
  ...
  createDirectory(uri: vscode.Uri): void {
    console.trace(`MemFs.createDirectory ${this.id}. uri: ${uri}`);
